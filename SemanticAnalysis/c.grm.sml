...
fn (i392,defaultPos,stack,
    (()):arg) =>
case (i392,stack)
of  ( 0, ( ( _, ( MlyValue.PROG_ITEMS PROG_ITEMS, PROG_ITEMS1left, PROG_ITEMS1right)) :: rest671)) => let val  result = MlyValue.PROGRAM ((*#line 103.42 "c.grm"*)PROG_ITEMS(*#line 596.1 "c.grm.sml"*)
)
 in ( LrTable.NT 0, ( result, PROG_ITEMS1left, PROG_ITEMS1right), rest671)
end
|  ( 1, ( rest671)) => let val  result = MlyValue.PROG_ITEMS ((*#line 105.42 "c.grm"*)[](*#line 600.1 "c.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, defaultPos, defaultPos), rest671)
end
|  ( 2, ( ( _, ( MlyValue.PROG_ITEMS PROG_ITEMS, _, PROG_ITEMS1right)) :: ( _, ( MlyValue.PROG_ITEM PROG_ITEM, PROG_ITEM1left, _)) :: rest671)) => let val  result = MlyValue.PROG_ITEMS ((*#line 106.42 "c.grm"*)PROG_ITEM :: PROG_ITEMS(*#line 604.1 "c.grm.sml"*)
)
 in ( LrTable.NT 2, ( result, PROG_ITEM1left, PROG_ITEMS1right), rest671)
end
|  ( 3, ( ( _, ( MlyValue.DIRECTIVES DIRECTIVES, DIRECTIVES1left, DIRECTIVES1right)) :: rest671)) => let val  result = MlyValue.PROG_ITEM ((*#line 108.38 "c.grm"*)Ast.ProgItemDirectives DIRECTIVES(*#line 608.1 "c.grm.sml"*)
)
 in ( LrTable.NT 3, ( result, DIRECTIVES1left, DIRECTIVES1right), rest671)
end
|  ( 4, ( ( _, ( MlyValue.DECSTMTS DECSTMTS, DECSTMTS1left, DECSTMTS1right)) :: rest671)) => let val  result = MlyValue.PROG_ITEM ((*#line 109.38 "c.grm"*)Ast.DecStmtsCons DECSTMTS(*#line 612.1 "c.grm.sml"*)
)
 in ( LrTable.NT 3, ( result, DECSTMTS1left, DECSTMTS1right), rest671)
end
|  ( 5, ( ( _, ( MlyValue.FUNC FUNC, FUNC1left, FUNC1right)) :: rest671)) => let val  result = MlyValue.PROG_ITEM ((*#line 110.38 "c.grm"*)FUNC(*#line 616.1 "c.grm.sml"*)
)
 in ( LrTable.NT 3, ( result, FUNC1left, FUNC1right), rest671)
end
|  ( 6, ( ( _, ( MlyValue.COMMENTSTMT COMMENTSTMT, COMMENTSTMT1left, COMMENTSTMT1right)) :: rest671)) => let val  result = MlyValue.PROG_ITEM ((*#line 111.38 "c.grm"*)Ast.ProgItemComments COMMENTSTMT(*#line 620.1 "c.grm.sml"*)
)
 in ( LrTable.NT 3, ( result, COMMENTSTMT1left, COMMENTSTMT1right), rest671)
end
|  ( 7, ( ( _, ( MlyValue.INCLUDE INCLUDE, INCLUDE1left, INCLUDE1right)) :: rest671)) => let val  result = MlyValue.DIRECTIVES ((*#line 114.38 "c.grm"*)Ast.Include INCLUDE(*#line 624.1 "c.grm.sml"*)
)
 in ( LrTable.NT 1, ( result, INCLUDE1left, INCLUDE1right), rest671)
end
|  ( 8, ( ( _, ( MlyValue.INCLUDEH INCLUDEH, INCLUDEH1left, INCLUDEH1right)) :: rest671)) => let val  result = MlyValue.DIRECTIVES ((*#line 115.38 "c.grm"*)Ast.Includeh INCLUDEH(*#line 628.1 "c.grm.sml"*)
)
 in ( LrTable.NT 1, ( result, INCLUDEH1left, INCLUDEH1right), rest671)
end
|  ( 9, ( ( _, ( MlyValue.ID_VALUES ID_VALUES, _, ID_VALUES1right)) :: ( _, ( MlyValue.ID ID, _, _)) :: ( _, ( _, DEFINE1left, _)) :: rest671)) => let val  result = MlyValue.DIRECTIVES ((*#line 116.38 "c.grm"*)Ast.Define (symbol ID, ID_VALUES)(*#line 632.1 "c.grm.sml"*)
)
 in ( LrTable.NT 1, ( result, DEFINE1left, ID_VALUES1right), rest671)
end
|  ( 10, ( ( _, ( _, INT1left, INT1right)) :: rest671)) => let val  result = MlyValue.PRIM ((*#line 119.38 "c.grm"*)Ast.INT(*#line 636.1 "c.grm.sml"*)
)
 in ( LrTable.NT 4, ( result, INT1left, INT1right), rest671)
end
|  ( 11, ( ( _, ( _, VOID1left, VOID1right)) :: rest671)) => let val  result = MlyValue.PRIM ((*#line 120.38 "c.grm"*)Ast.VOID(*#line 640.1 "c.grm.sml"*)
)
 in ( LrTable.NT 4, ( result, VOID1left, VOID1right), rest671)
end
|  ( 12, ( ( _, ( _, CHAR1left, CHAR1right)) :: rest671)) => let val  result = MlyValue.PRIM ((*#line 121.38 "c.grm"*)Ast.CHAR(*#line 644.1 "c.grm.sml"*)
)
 in ( LrTable.NT 4, ( result, CHAR1left, CHAR1right), rest671)
end
|  ( 13, ( ( _, ( _, FLOAT1left, FLOAT1right)) :: rest671)) => let val  result = MlyValue.PRIM ((*#line 122.38 "c.grm"*)Ast.FLOAT(*#line 648.1 "c.grm.sml"*)
)
 in ( LrTable.NT 4, ( result, FLOAT1left, FLOAT1right), rest671)
end
|  ( 14, ( ( _, ( _, DOUBLE1left, DOUBLE1right)) :: rest671)) => let val  result = MlyValue.PRIM ((*#line 123.38 "c.grm"*)Ast.DOUBLE(*#line 652.1 "c.grm.sml"*)
)
 in ( LrTable.NT 4, ( result, DOUBLE1left, DOUBLE1right), rest671)
end
|  ( 15, ( ( _, ( _, LONG1left, LONG1right)) :: rest671)) => let val  result = MlyValue.PRIM ((*#line 124.38 "c.grm"*)Ast.LONG(*#line 656.1 "c.grm.sml"*)
)
 in ( LrTable.NT 4, ( result, LONG1left, LONG1right), rest671)
end
|  ( 16, ( ( _, ( _, _, SEMICOLON1right)) :: ( _, ( MlyValue.DECSTMT DECSTMT, _, _)) :: ( _, ( MlyValue.PRIM PRIM, PRIM1left, _)) :: rest671)) => let val  result = MlyValue.DECSTMTS ((*#line 126.38 "c.grm"*)Ast.DecStmtCons (PRIM, DECSTMT)(*#line 660.1 "c.grm.sml"*)
)
 in ( LrTable.NT 5, ( result, PRIM1left, SEMICOLON1right), rest671)
end
|  ( 17, ( ( _, ( MlyValue.DECS DECS, DECS1left, DECS1right)) :: rest671)) => let val  result = MlyValue.DECSTMT ((*#line 128.39 "c.grm"*)DECS :: [](*#line 664.1 "c.grm.sml"*)
)
 in ( LrTable.NT 6, ( result, DECS1left, DECS1right), rest671)
end
|  ( 18, ( ( _, ( MlyValue.DECSTMT DECSTMT, _, DECSTMT1right)) :: _ :: ( _, ( MlyValue.DECS DECS, DECS1left, _)) :: rest671)) => let val  result = MlyValue.DECSTMT ((*#line 129.39 "c.grm"*)DECS :: DECSTMT(*#line 668.1 "c.grm.sml"*)
)
 in ( LrTable.NT 6, ( result, DECS1left, DECSTMT1right), rest671)
end
|  ( 19, ( ( _, ( MlyValue.ID ID, ID1left, ID1right)) :: rest671)) => let val  result = MlyValue.DECS ((*#line 131.32 "c.grm"*)Ast.Variable (symbol ID)(*#line 672.1 "c.grm.sml"*)
)
 in ( LrTable.NT 7, ( result, ID1left, ID1right), rest671)
end
|  ( 20, ( ( _, ( MlyValue.EXP EXP, _, EXP1right)) :: _ :: ( _, ( MlyValue.ID ID, ID1left, _)) :: rest671)) => let val  result = MlyValue.DECS ((*#line 132.32 "c.grm"*)Ast.DecVar (symbol ID, EXP)(*#line 676.1 "c.grm.sml"*)
)
 in ( LrTable.NT 7, ( result, ID1left, EXP1right), rest671)
end
|  ( 21, ( ( _, ( MlyValue.ID ID, ID1left, ID1right)) :: rest671)) => let val  result = MlyValue.ID_VALUES ((*#line 135.32 "c.grm"*)Ast.IdValuesVar (symbol ID)(*#line 680.1 "c.grm.sml"*)
)
 in ( LrTable.NT 8, ( result, ID1left, ID1right), rest671)
end
|  ( 22, ( ( _, ( MlyValue.INTVAL INTVAL, INTVAL1left, INTVAL1right)) :: rest671)) => let val  result = MlyValue.ID_VALUES ((*#line 136.32 "c.grm"*)Ast.IntVal INTVAL(*#line 684.1 "c.grm.sml"*)
)
 in ( LrTable.NT 8, ( result, INTVAL1left, INTVAL1right), rest671)
end
|  ( 23, ( ( _, ( MlyValue.FLOATVAL FLOATVAL, FLOATVAL1left, FLOATVAL1right)) :: rest671)) => let val  result = MlyValue.ID_VALUES ((*#line 137.32 "c.grm"*)Ast.FloatVal FLOATVAL(*#line 688.1 "c.grm.sml"*)
)
 in ( LrTable.NT 8, ( result, FLOATVAL1left, FLOATVAL1right), rest671)
end
|  ( 24, ( ( _, ( MlyValue.CHARVAL CHARVAL, CHARVAL1left, CHARVAL1right)) :: rest671)) => let val  result = MlyValue.ID_VALUES ((*#line 138.32 "c.grm"*)Ast.CharVal CHARVAL(*#line 692.1 "c.grm.sml"*)
)
 in ( LrTable.NT 8, ( result, CHARVAL1left, CHARVAL1right), rest671)
end
|  ( 25, ( ( _, ( MlyValue.STRING STRING, STRING1left, STRING1right)) :: rest671)) => let val  result = MlyValue.ID_VALUES ((*#line 139.32 "c.grm"*)Ast.StringVal STRING(*#line 696.1 "c.grm.sml"*)
)
 in ( LrTable.NT 8, ( result, STRING1left, STRING1right), rest671)
end
|  ( 26, ( ( _, ( MlyValue.EXP EXP2, _, EXP2right)) :: ( _, ( MlyValue.BINOP BINOP, _, _)) :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.EXP_OP ((*#line 141.44 "c.grm"*)Ast.BinaryOp (EXP1, BINOP, EXP2)(*#line 700.1 "c.grm.sml"*)
)
 in ( LrTable.NT 9, ( result, EXP1left, EXP2right), rest671)
end
|  ( 27, ( ( _, ( MlyValue.INCDEC INCDEC, _, INCDEC1right)) :: ( _, ( MlyValue.ID ID, ID1left, _)) :: rest671)) => let val  result = MlyValue.EXP_OP ((*#line 142.32 "c.grm"*)Ast.IdIncDec (symbol ID, INCDEC)(*#line 704.1 "c.grm.sml"*)
)
 in ( LrTable.NT 9, ( result, ID1left, INCDEC1right), rest671)
end
|  ( 28, ( ( _, ( MlyValue.ID ID, _, ID1right)) :: ( _, ( MlyValue.INCDEC INCDEC, INCDEC1left, _)) :: rest671)) => let val  result = MlyValue.EXP_OP ((*#line 143.32 "c.grm"*)Ast.IncDecId (symbol ID, INCDEC)(*#line 708.1 "c.grm.sml"*)
)
 in ( LrTable.NT 9, ( result, INCDEC1left, ID1right), rest671)
end
|  ( 29, ( ( _, ( MlyValue.EXP EXP, _, EXP1right)) :: ( _, ( MlyValue.UNOP UNOP, UNOP1left, _)) :: rest671)) => let val  result = MlyValue.EXP_OP ((*#line 144.45 "c.grm"*)Ast.UnaryOp (UNOP, EXP)(*#line 712.1 "c.grm.sml"*)
)
 in ( LrTable.NT 9, ( result, UNOP1left, EXP1right), rest671)
end
|  ( 30, ( ( _, ( _, PLUS1left, PLUS1right)) :: rest671)) => let val  result = MlyValue.BINOP ((*#line 146.32 "c.grm"*)Ast.PLUS(*#line 716.1 "c.grm.sml"*)
)
 in ( LrTable.NT 10, ( result, PLUS1left, PLUS1right), rest671)
end
|  ( 31, ( ( _, ( _, MINUS1left, MINUS1right)) :: rest671)) => let val  result = MlyValue.BINOP ((*#line 147.32 "c.grm"*)Ast.MINUS(*#line 720.1 "c.grm.sml"*)
)
 in ( LrTable.NT 10, ( result, MINUS1left, MINUS1right), rest671)
end
|  ( 32, ( ( _, ( _, MUL1left, MUL1right)) :: rest671)) => let val  result = MlyValue.BINOP ((*#line 148.32 "c.grm"*)Ast.MUL(*#line 724.1 "c.grm.sml"*)
)
 in ( LrTable.NT 10, ( result, MUL1left, MUL1right), rest671)
end
|  ( 33, ( ( _, ( _, DIV1left, DIV1right)) :: rest671)) => let val  result = MlyValue.BINOP ((*#line 149.32 "c.grm"*)Ast.DIV(*#line 728.1 "c.grm.sml"*)
)
 in ( LrTable.NT 10, ( result, DIV1left, DIV1right), rest671)
end
|  ( 34, ( ( _, ( _, MODULUS1left, MODULUS1right)) :: rest671)) => let val  result = MlyValue.BINOP ((*#line 150.32 "c.grm"*)Ast.MODULUS(*#line 732.1 "c.grm.sml"*)
)
 in ( LrTable.NT 10, ( result, MODULUS1left, MODULUS1right), rest671)
end
|  ( 35, ( ( _, ( MlyValue.COMPARE COMPARE, COMPARE1left, COMPARE1right)) :: rest671)) => let val  result = MlyValue.BINOP ((*#line 151.32 "c.grm"*)Ast.BinopCompare COMPARE(*#line 736.1 "c.grm.sml"*)
)
 in ( LrTable.NT 10, ( result, COMPARE1left, COMPARE1right), rest671)
end
|  ( 36, ( ( _, ( MlyValue.BITWISE BITWISE, BITWISE1left, BITWISE1right)) :: rest671)) => let val  result = MlyValue.BINOP ((*#line 152.32 "c.grm"*)Ast.BinopBitwise BITWISE(*#line 740.1 "c.grm.sml"*)
)
 in ( LrTable.NT 10, ( result, BITWISE1left, BITWISE1right), rest671)
end
|  ( 37, ( ( _, ( MlyValue.LOGICAL LOGICAL, LOGICAL1left, LOGICAL1right)) :: rest671)) => let val  result = MlyValue.BINOP ((*#line 153.32 "c.grm"*)Ast.BinopLogical LOGICAL(*#line 744.1 "c.grm.sml"*)
)
 in ( LrTable.NT 10, ( result, LOGICAL1left, LOGICAL1right), rest671)
end
|  ( 38, ( ( _, ( _, NE1left, NE1right)) :: rest671)) => let val  result = MlyValue.COMPARE ((*#line 155.32 "c.grm"*)Ast.NE(*#line 748.1 "c.grm.sml"*)
)
 in ( LrTable.NT 11, ( result, NE1left, NE1right), rest671)
end
|  ( 39, ( ( _, ( _, EQ1left, EQ1right)) :: rest671)) => let val  result = MlyValue.COMPARE ((*#line 156.32 "c.grm"*)Ast.EQ(*#line 752.1 "c.grm.sml"*)
)
 in ( LrTable.NT 11, ( result, EQ1left, EQ1right), rest671)
end
|  ( 40, ( ( _, ( _, GT1left, GT1right)) :: rest671)) => let val  result = MlyValue.COMPARE ((*#line 157.32 "c.grm"*)Ast.GT(*#line 756.1 "c.grm.sml"*)
)
 in ( LrTable.NT 11, ( result, GT1left, GT1right), rest671)
end
|  ( 41, ( ( _, ( _, GTE1left, GTE1right)) :: rest671)) => let val  result = MlyValue.COMPARE ((*#line 158.32 "c.grm"*)Ast.GTE(*#line 760.1 "c.grm.sml"*)
)
 in ( LrTable.NT 11, ( result, GTE1left, GTE1right), rest671)
end
|  ( 42, ( ( _, ( _, LT1left, LT1right)) :: rest671)) => let val  result = MlyValue.COMPARE ((*#line 159.32 "c.grm"*)Ast.LT(*#line 764.1 "c.grm.sml"*)
)
 in ( LrTable.NT 11, ( result, LT1left, LT1right), rest671)
end
|  ( 43, ( ( _, ( _, LTE1left, LTE1right)) :: rest671)) => let val  result = MlyValue.COMPARE ((*#line 160.32 "c.grm"*)Ast.LTE(*#line 768.1 "c.grm.sml"*)
)
 in ( LrTable.NT 11, ( result, LTE1left, LTE1right), rest671)
end
|  ( 44, ( ( _, ( _, BITAND1left, BITAND1right)) :: rest671)) => let val  result = MlyValue.BITWISE ((*#line 162.32 "c.grm"*)Ast.BITAND(*#line 772.1 "c.grm.sml"*)
)
 in ( LrTable.NT 12, ( result, BITAND1left, BITAND1right), rest671)
end
|  ( 45, ( ( _, ( _, BITOR1left, BITOR1right)) :: rest671)) => let val  result = MlyValue.BITWISE ((*#line 163.32 "c.grm"*)Ast.BITOR(*#line 776.1 "c.grm.sml"*)
)
 in ( LrTable.NT 12, ( result, BITOR1left, BITOR1right), rest671)
end
|  ( 46, ( ( _, ( _, XOR1left, XOR1right)) :: rest671)) => let val  result = MlyValue.BITWISE ((*#line 164.32 "c.grm"*)Ast.XOR(*#line 780.1 "c.grm.sml"*)
)
 in ( LrTable.NT 12, ( result, XOR1left, XOR1right), rest671)
end
|  ( 47, ( ( _, ( _, LEFTSHIFT1left, LEFTSHIFT1right)) :: rest671)) => let val  result = MlyValue.BITWISE ((*#line 165.32 "c.grm"*)Ast.LEFTSHIFT(*#line 784.1 "c.grm.sml"*)
)
 in ( LrTable.NT 12, ( result, LEFTSHIFT1left, LEFTSHIFT1right), rest671)
end
|  ( 48, ( ( _, ( _, RIGHTSHIFT1left, RIGHTSHIFT1right)) :: rest671)) => let val  result = MlyValue.BITWISE ((*#line 166.32 "c.grm"*)Ast.RIGHTSHIFT(*#line 788.1 "c.grm.sml"*)
)
 in ( LrTable.NT 12, ( result, RIGHTSHIFT1left, RIGHTSHIFT1right), rest671)
end
|  ( 49, ( ( _, ( _, AND1left, AND1right)) :: rest671)) => let val  result = MlyValue.LOGICAL ((*#line 168.32 "c.grm"*)Ast.AND(*#line 792.1 "c.grm.sml"*)
)
 in ( LrTable.NT 13, ( result, AND1left, AND1right), rest671)
end
|  ( 50, ( ( _, ( _, OR1left, OR1right)) :: rest671)) => let val  result = MlyValue.LOGICAL ((*#line 169.32 "c.grm"*)Ast.OR(*#line 796.1 "c.grm.sml"*)
)
 in ( LrTable.NT 13, ( result, OR1left, OR1right), rest671)
end
|  ( 51, ( ( _, ( _, ASSIGN1left, ASSIGN1right)) :: rest671)) => let val  result = MlyValue.ASSIGNMENT ((*#line 171.32 "c.grm"*)Ast.ASSIGN(*#line 800.1 "c.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, ASSIGN1left, ASSIGN1right), rest671)
end
|  ( 52, ( ( _, ( _, PLUSA1left, PLUSA1right)) :: rest671)) => let val  result = MlyValue.ASSIGNMENT ((*#line 172.32 "c.grm"*)Ast.PLUSA(*#line 804.1 "c.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, PLUSA1left, PLUSA1right), rest671)
end
|  ( 53, ( ( _, ( _, MINUSA1left, MINUSA1right)) :: rest671)) => let val  result = MlyValue.ASSIGNMENT ((*#line 173.32 "c.grm"*)Ast.MINUSA(*#line 808.1 "c.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, MINUSA1left, MINUSA1right), rest671)
end
|  ( 54, ( ( _, ( _, TIMESA1left, TIMESA1right)) :: rest671)) => let val  result = MlyValue.ASSIGNMENT ((*#line 174.32 "c.grm"*)Ast.TIMESA(*#line 812.1 "c.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, TIMESA1left, TIMESA1right), rest671)
end
|  ( 55, ( ( _, ( _, DIVA1left, DIVA1right)) :: rest671)) => let val  result = MlyValue.ASSIGNMENT ((*#line 175.32 "c.grm"*)Ast.DIVA(*#line 816.1 "c.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, DIVA1left, DIVA1right), rest671)
end
|  ( 56, ( ( _, ( _, MODULUSA1left, MODULUSA1right)) :: rest671)) => let val  result = MlyValue.ASSIGNMENT ((*#line 176.32 "c.grm"*)Ast.MODULUSA(*#line 820.1 "c.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, MODULUSA1left, MODULUSA1right), rest671)
end
|  ( 57, ( ( _, ( _, LEFTSHIFTA1left, LEFTSHIFTA1right)) :: rest671)) => let val  result = MlyValue.ASSIGNMENT ((*#line 177.32 "c.grm"*)Ast.LEFTSHIFTA(*#line 824.1 "c.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, LEFTSHIFTA1left, LEFTSHIFTA1right), rest671)
end
|  ( 58, ( ( _, ( _, RIGHTSHIFTA1left, RIGHTSHIFTA1right)) :: rest671)) => let val  result = MlyValue.ASSIGNMENT ((*#line 178.32 "c.grm"*)Ast.RIGHTSHIFTA(*#line 828.1 "c.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, RIGHTSHIFTA1left, RIGHTSHIFTA1right), rest671)
end
|  ( 59, ( ( _, ( _, BITORA1left, BITORA1right)) :: rest671)) => let val  result = MlyValue.ASSIGNMENT ((*#line 179.32 "c.grm"*)Ast.BITORA(*#line 832.1 "c.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, BITORA1left, BITORA1right), rest671)
end
|  ( 60, ( ( _, ( _, BITANDA1left, BITANDA1right)) :: rest671)) => let val  result = MlyValue.ASSIGNMENT ((*#line 180.32 "c.grm"*)Ast.BITANDA(*#line 836.1 "c.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, BITANDA1left, BITANDA1right), rest671)
end
|  ( 61, ( ( _, ( _, XORA1left, XORA1right)) :: rest671)) => let val  result = MlyValue.ASSIGNMENT ((*#line 181.32 "c.grm"*)Ast.XORA(*#line 840.1 "c.grm.sml"*)
)
 in ( LrTable.NT 14, ( result, XORA1left, XORA1right), rest671)
end
|  ( 62, ( ( _, ( _, INC1left, INC1right)) :: rest671)) => let val  result = MlyValue.INCDEC ((*#line 184.32 "c.grm"*)Ast.INC(*#line 844.1 "c.grm.sml"*)
)
 in ( LrTable.NT 15, ( result, INC1left, INC1right), rest671)
end
|  ( 63, ( ( _, ( _, DEC1left, DEC1right)) :: rest671)) => let val  result = MlyValue.INCDEC ((*#line 185.32 "c.grm"*)Ast.DEC(*#line 848.1 "c.grm.sml"*)
)
 in ( LrTable.NT 15, ( result, DEC1left, DEC1right), rest671)
end
|  ( 64, ( ( _, ( _, NOT1left, NOT1right)) :: rest671)) => let val  result = MlyValue.UNOP ((*#line 187.32 "c.grm"*)Ast.NOT(*#line 852.1 "c.grm.sml"*)
)
 in ( LrTable.NT 16, ( result, NOT1left, NOT1right), rest671)
end
|  ( 65, ( ( _, ( _, COMPLEMENT1left, COMPLEMENT1right)) :: rest671)) => let val  result = MlyValue.UNOP ((*#line 188.32 "c.grm"*)Ast.COMPLEMENT(*#line 856.1 "c.grm.sml"*)
)
 in ( LrTable.NT 16, ( result, COMPLEMENT1left, COMPLEMENT1right), rest671)
end
|  ( 66, ( ( _, ( MlyValue.ID_VALUES ID_VALUES, ID_VALUES1left, ID_VALUES1right)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 190.38 "c.grm"*)Ast.IdValuesCons ID_VALUES(*#line 860.1 "c.grm.sml"*)
)
 in ( LrTable.NT 17, ( result, ID_VALUES1left, ID_VALUES1right), rest671)
end
|  ( 67, ( ( _, ( MlyValue.EXP_OP EXP_OP, EXP_OP1left, EXP_OP1right)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 191.38 "c.grm"*)Ast.ExpOpCons EXP_OP(*#line 864.1 "c.grm.sml"*)
)
 in ( LrTable.NT 17, ( result, EXP_OP1left, EXP_OP1right), rest671)
end
|  ( 68, ( ( _, ( MlyValue.EXP EXP, _, EXP1right)) :: ( _, ( MlyValue.ASSIGNMENT ASSIGNMENT, _, _)) :: ( _, ( MlyValue.ID ID, ID1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 192.38 "c.grm"*)Ast.AssignCons (symbol ID, ASSIGNMENT, EXP)(*#line 868.1 "c.grm.sml"*)
)
 in ( LrTable.NT 17, ( result, ID1left, EXP1right), rest671)
end
|  ( 69, ( ( _, ( MlyValue.EXP EXP3, _, EXP3right)) :: _ :: ( _, ( MlyValue.EXP EXP2, _, _)) :: _ :: ( _, ( MlyValue.EXP EXP1, EXP1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 193.50 "c.grm"*)Ast.TernaryOp (EXP1, EXP2, EXP3)(*#line 872.1 "c.grm.sml"*)
)
 in ( LrTable.NT 17, ( result, EXP1left, EXP3right), rest671)
end
|  ( 70, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.EXP EXP, _, _)) :: ( _, ( _, LPAREN1left, _)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 194.38 "c.grm"*)Ast.Paren (EXP)(*#line 876.1 "c.grm.sml"*)
)
 in ( LrTable.NT 17, ( result, LPAREN1left, RPAREN1right), rest671)
end
|  ( 71, ( ( _, ( MlyValue.FUNC_CALL FUNC_CALL, FUNC_CALL1left, FUNC_CALL1right)) :: rest671)) => let val  result = MlyValue.EXP ((*#line 195.38 "c.grm"*)Ast.ExpFuncCall FUNC_CALL(*#line 880.1 "c.grm.sml"*)
)
 in ( LrTable.NT 17, ( result, FUNC_CALL1left, FUNC_CALL1right), rest671)
end
|  ( 72, ( rest671)) => let val  result = MlyValue.PARAMS ((*#line 197.45 "c.grm"*) [] (*#line 884.1 "c.grm.sml"*)
)
 in ( LrTable.NT 18, ( result, defaultPos, defaultPos), rest671)
end
|  ( 73, ( ( _, ( MlyValue.DECS DECS, _, DECS1right)) :: ( _, ( MlyValue.PRIM PRIM, PRIM1left, _)) :: rest671)) => let val  result = MlyValue.PARAMS ((*#line 198.45 "c.grm"*)Ast.ParamsCons (PRIM, DECS) :: [](*#line 888.1 "c.grm.sml"*)
)
 in ( LrTable.NT 18, ( result, PRIM1left, DECS1right), rest671)
end
|  ( 74, ( ( _, ( MlyValue.PARAMS PARAMS, _, PARAMS1right)) :: _ :: ( _, ( MlyValue.DECS DECS, _, _)) :: ( _, ( MlyValue.PRIM PRIM, PRIM1left, _)) :: rest671)) => let val  result = MlyValue.PARAMS ((*#line 199.45 "c.grm"*)Ast.ParamsCons (PRIM, DECS) :: PARAMS(*#line 892.1 "c.grm.sml"*)
)
 in ( LrTable.NT 18, ( result, PRIM1left, PARAMS1right), rest671)
end
|  ( 75, ( ( _, ( MlyValue.BLOCK BLOCK, _, BLOCK1right)) :: _ :: ( _, ( MlyValue.PARAMS PARAMS, _, _)) :: _ :: ( _, ( MlyValue.ID ID, _, _)) :: ( _, ( MlyValue.PRIM PRIM, PRIM1left, _)) :: rest671)) => let val  result = MlyValue.FUNC ((*#line 202.62 "c.grm"*)Ast.FuncCons (PRIM, symbol ID, PARAMS, Ast.Block BLOCK)(*#line 896.1 "c.grm.sml"*)
)
 in ( LrTable.NT 19, ( result, PRIM1left, BLOCK1right), rest671)
end
|  ( 76, ( rest671)) => let val  result = MlyValue.ARGUMENTS ((*#line 204.44 "c.grm"*)[](*#line 900.1 "c.grm.sml"*)
)
 in ( LrTable.NT 20, ( result, defaultPos, defaultPos), rest671)
end
|  ( 77, ( ( _, ( MlyValue.EXP EXP, EXP1left, EXP1right)) :: rest671)) => let val  result = MlyValue.ARGUMENTS ((*#line 205.44 "c.grm"*)EXP :: [](*#line 904.1 "c.grm.sml"*)
)
 in ( LrTable.NT 20, ( result, EXP1left, EXP1right), rest671)
end
|  ( 78, ( ( _, ( MlyValue.ARGUMENTS ARGUMENTS, _, ARGUMENTS1right)) :: _ :: ( _, ( MlyValue.EXP EXP, EXP1left, _)) :: rest671)) => let val  result = MlyValue.ARGUMENTS ((*#line 206.44 "c.grm"*)EXP :: ARGUMENTS(*#line 908.1 "c.grm.sml"*)
)
 in ( LrTable.NT 20, ( result, EXP1left, ARGUMENTS1right), rest671)
end
|  ( 79, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.ARGUMENTS ARGUMENTS, _, _)) :: _ :: ( _, ( MlyValue.ID ID, ID1left, _)) :: rest671)) => let val  result = MlyValue.FUNC_CALL ((*#line 208.45 "c.grm"*)Ast.FuncCallCons (symbol ID, ARGUMENTS)(*#line 912.1 "c.grm.sml"*)
)
 in ( LrTable.NT 21, ( result, ID1left, RPAREN1right), rest671)
end
|  ( 80, ( ( _, ( _, _, RBRACE1right)) :: ( _, ( MlyValue.STATEMENTS STATEMENTS, _, _)) :: ( _, ( _, LBRACE1left, _)) :: rest671)) => let val  result = MlyValue.BLOCK ((*#line 210.44 "c.grm"*)STATEMENTS(*#line 916.1 "c.grm.sml"*)
)
 in ( LrTable.NT 22, ( result, LBRACE1left, RBRACE1right), rest671)
end
|  ( 81, ( rest671)) => let val  result = MlyValue.STATEMENTS ((*#line 212.44 "c.grm"*)[](*#line 920.1 "c.grm.sml"*)
)
 in ( LrTable.NT 23, ( result, defaultPos, defaultPos), rest671)
end
|  ( 82, ( ( _, ( MlyValue.STATEMENTS STATEMENTS, _, STATEMENTS1right)) :: ( _, ( MlyValue.STATEMENT STATEMENT, STATEMENT1left, _)) :: rest671)) => let val  result = MlyValue.STATEMENTS ((*#line 213.44 "c.grm"*)STATEMENT :: STATEMENTS(*#line 924.1 "c.grm.sml"*)
)
 in ( LrTable.NT 23, ( result, STATEMENT1left, STATEMENTS1right), rest671)
end
|  ( 83, ( ( _, ( MlyValue.STATEMENTS STATEMENTS, _, STATEMENTS1right)) :: ( _, ( MlyValue.COMMENTSTMT COMMENTSTMT, COMMENTSTMT1left, _)) :: rest671)) => let val  result = MlyValue.STATEMENTS ((*#line 214.44 "c.grm"*)Ast.StmtCommentCons COMMENTSTMT :: STATEMENTS(*#line 928.1 "c.grm.sml"*)
)
 in ( LrTable.NT 23, ( result, COMMENTSTMT1left, STATEMENTS1right), rest671)
end
|  ( 84, ( ( _, ( MlyValue.STATEMENT STATEMENT, _, STATEMENT1right)) :: ( _, ( MlyValue.EXP EXP, _, _)) :: ( _, ( _, IF1left, _)) :: rest671)) => let val  result = MlyValue.STATEMENT ((*#line 217.61 "c.grm"*)Ast.IF (EXP, STATEMENT)(*#line 932.1 "c.grm.sml"*)
)
 in ( LrTable.NT 24, ( result, IF1left, STATEMENT1right), rest671)
end
|  ( 85, ( ( _, ( MlyValue.STATEMENT STATEMENT2, _, STATEMENT2right)) :: _ :: ( _, ( MlyValue.STATEMENT STATEMENT1, _, _)) :: ( _, ( MlyValue.EXP EXP, _, _)) :: ( _, ( _, IF1left, _)) :: rest671)) => let val  result = MlyValue.STATEMENT ((*#line 218.50 "c.grm"*)Ast.IFELSE (EXP, STATEMENT1, STATEMENT2)(*#line 936.1 "c.grm.sml"*)
)
 in ( LrTable.NT 24, ( result, IF1left, STATEMENT2right), rest671)
end
|  ( 86, ( ( _, ( MlyValue.DECSTMTS DECSTMTS, DECSTMTS1left, DECSTMTS1right)) :: rest671)) => let val  result = MlyValue.STATEMENT ((*#line 219.50 "c.grm"*)Ast.StmtDecStmts DECSTMTS(*#line 940.1 "c.grm.sml"*)
)
 in ( LrTable.NT 24, ( result, DECSTMTS1left, DECSTMTS1right), rest671)
end
|  ( 87, ( ( _, ( MlyValue.RETURNSTMT RETURNSTMT, RETURNSTMT1left, RETURNSTMT1right)) :: rest671)) => let val  result = MlyValue.STATEMENT ((*#line 220.50 "c.grm"*)Ast.ReturnStmtCons RETURNSTMT(*#line 944.1 "c.grm.sml"*)
)
 in ( LrTable.NT 24, ( result, RETURNSTMT1left, RETURNSTMT1right), rest671)
end
|  ( 88, ( ( _, ( _, _, SEMICOLON1right)) :: ( _, ( _, BREAK1left, _)) :: rest671)) => let val  result = MlyValue.STATEMENT ((*#line 221.50 "c.grm"*)Ast.BREAK(*#line 948.1 "c.grm.sml"*)
)
 in ( LrTable.NT 24, ( result, BREAK1left, SEMICOLON1right), rest671)
end
|  ( 89, ( ( _, ( _, _, SEMICOLON1right)) :: ( _, ( _, CONTINUE1left, _)) :: rest671)) => let val  result = MlyValue.STATEMENT ((*#line 222.50 "c.grm"*)Ast.CONTINUE(*#line 952.1 "c.grm.sml"*)
)
 in ( LrTable.NT 24, ( result, CONTINUE1left, SEMICOLON1right), rest671)
end
|  ( 90, ( ( _, ( MlyValue.BLOCK BLOCK, BLOCK1left, BLOCK1right)) :: rest671)) => let val  result = MlyValue.STATEMENT ((*#line 223.50 "c.grm"*)Ast.Block BLOCK(*#line 956.1 "c.grm.sml"*)
)
 in ( LrTable.NT 24, ( result, BLOCK1left, BLOCK1right), rest671)
end
|  ( 91, ( ( _, ( MlyValue.STATEMENT STATEMENT, _, STATEMENT1right)) :: ( _, ( MlyValue.EXP EXP, _, _)) :: ( _, ( _, WHILE1left, _)) :: rest671)) => let val  result = MlyValue.STATEMENT ((*#line 224.50 "c.grm"*)Ast.While (EXP, STATEMENT)(*#line 960.1 "c.grm.sml"*)
)
 in ( LrTable.NT 24, ( result, WHILE1left, STATEMENT1right), rest671)
end
|  ( 92, ( ( _, ( _, _, SEMICOLON1right)) :: ( _, ( MlyValue.EXP EXP, EXP1left, _)) :: rest671)) => let val  result = MlyValue.STATEMENT ((*#line 225.50 "c.grm"*)Ast.ExpCons EXP(*#line 964.1 "c.grm.sml"*)
)
 in ( LrTable.NT 24, ( result, EXP1left, SEMICOLON1right), rest671)
end
|  ( 93, ( ( _, ( _, _, SEMICOLON1right)) :: ( _, ( _, RETURN1left, _)) :: rest671)) => let val  result = MlyValue.RETURNSTMT ((*#line 227.44 "c.grm"*)Ast.RETURN(*#line 968.1 "c.grm.sml"*)
)
 in ( LrTable.NT 25, ( result, RETURN1left, SEMICOLON1right), rest671)
end
|  ( 94, ( ( _, ( _, _, SEMICOLON1right)) :: ( _, ( MlyValue.EXP EXP, _, _)) :: ( _, ( _, RETURN1left, _)) :: rest671)) => let val  result = MlyValue.RETURNSTMT ((*#line 228.44 "c.grm"*)Ast.ReturnCons EXP(*#line 972.1 "c.grm.sml"*)
)
 in ( LrTable.NT 25, ( result, RETURN1left, SEMICOLON1right), rest671)
end
|  ( 95, ( ( _, ( MlyValue.SINGLECOMMENT SINGLECOMMENT, SINGLECOMMENT1left, SINGLECOMMENT1right)) :: rest671)) => let val  result = MlyValue.COMMENTSTMT ((*#line 230.44 "c.grm"*)Ast.SingleComment SINGLECOMMENT(*#line 976.1 "c.grm.sml"*)
)
 in ( LrTable.NT 26, ( result, SINGLECOMMENT1left, SINGLECOMMENT1right), rest671)
end
|  ( 96, ( ( _, ( MlyValue.MULTICOMMENT MULTICOMMENT, MULTICOMMENT1left, MULTICOMMENT1right)) :: rest671)) => let val  result = MlyValue.COMMENTSTMT ((*#line 231.44 "c.grm"*)Ast.MultiComment MULTICOMMENT(*#line 980.1 "c.grm.sml"*)
)
